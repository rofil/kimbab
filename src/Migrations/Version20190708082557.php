 ...
 */
final class Version20190708082557 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE intellectual_property ADD classification SMALLINT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE intellectual_property DROP classification');
    }
}

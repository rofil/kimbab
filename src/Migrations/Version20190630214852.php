 ...
 */
final class Version20190630214852 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE lecturer CHANGE nip nip VARCHAR(255) DEFAULT NULL, CHANGE nidn nidn VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE lecturer CHANGE nip nip VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE nidn nidn VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}

 ...
 */
final class Version20191009204900 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE lecturer ADD email VARCHAR(255) DEFAULT NULL, ADD expertises VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE lecturer DROP email, DROP expertises');
    }
}

 ...
 */
final class Version20190922144832 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE lecturer ADD user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE lecturer ADD CONSTRAINT FK_14CF5146A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_14CF5146A76ED395 ON lecturer (user_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_14CF5146A76ED395 ON lecturer');
        $this->addSql('ALTER TABLE lecturer DROP user_id');
    }
}

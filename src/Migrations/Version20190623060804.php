 ...
 */
final class Version20190623060804 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE intellectual_property_lecturer ADD CONSTRAINT FK_AE754D18BA2D8762 FOREIGN KEY (lecturer_id) REFERENCES lecturer (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE intellectual_property_lecturer DROP FOREIGN KEY FK_AE754D18BA2D8762');

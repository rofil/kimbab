 ...
 */
final class Version20190924081600 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE additional_output_lecturer DROP order_number');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE additional_output_lecturer ADD order_number INT DEFAULT NULL');

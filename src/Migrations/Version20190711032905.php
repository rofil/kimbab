 ...
 */
final class Version20190711032905 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE lecturer CHANGE education education INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE lecturer CHANGE education education INT NOT NULL');
    }
}
